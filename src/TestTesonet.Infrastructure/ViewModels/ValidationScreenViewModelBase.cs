...
namespace TestTesonet.Infrastructure.ViewModels
{
    ...
    /// </summary>
    public abstract class ValidationScreenViewModelBase : Screen, 
		IDataErrorInfo, IValidationExceptionHandler
    {
        private readonly Dictionary<string, Func<ValidationScreenViewModelBase, object>> _propertyGetters;
        private readonly Dictionary<string, ValidationAttribute[]> _validators;

        private int _validationExceptionCount;

        protected ValidationScreenViewModelBase()
        {
        ...
        private Func<ValidationScreenViewModelBase, object> GetValueGetter(PropertyInfo property)
        {
